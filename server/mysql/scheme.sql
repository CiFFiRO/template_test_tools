...
-- -----------------------------------------------------
-- Table `server`.`template_group_task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `server`.`template_group_task` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `template` MEDIUMBLOB NOT NULL,
  PRIMARY KEY (`id`, `user_id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_template_group_task_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_template_group_task_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `server`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `server`.`template_task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `server`.`template_task` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `template` MEDIUMBLOB NOT NULL,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  PRIMARY KEY (`id`, `user_id`),
  INDEX `fk_template_task_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_template_task_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `server`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
